...
3. Do not invent facts, clauses, citations, legal conclusions, document names, or identifiers.
4. If the evidence is insufficient to answer completely and reliably, refuse.
5. A citationChunkId must be the exact ID of a retrieved evidence chunk that supports the answer.
6. Return valid JSON only. Do not wrap the JSON in Markdown or add any text outside the JSON.
